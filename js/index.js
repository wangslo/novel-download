    ...
    var weRead = function(g) {
        var ay = {
            init: function() {
                ...
                // $("#nav_QRCode").attr('href','http://dl.tap2world.com/tap2world_V2.4.5_'+ this.getNowFormatDate() +'_Product_xggtt_guangwang.apk');
            },
            setGlobal: function() {
            ...
            setStyle: function() {
                if (GLOBAL.DEVICE_TYPE === 0) {
                    ...
                    // ah1.style.display = 'none';
                } else if (GLOBAL.DEVICE_TYPE === 1) {
                    ax.style.display = 'none';
                    ai.style.display = 'block';
                    ah.href = 'https://itunes.apple.com/cn/app//id1454354750?mt=8';
                } else if (GLOBAL.DEVICE_TYPE === 2){
                    ax.style.display = 'none';
                    // ab1.style.display = 'block';
                    ag.style.display = 'block';
                    // agp.style.display = 'block';
                    ah.href = 'http://mh.dpqct.com/meihu_v1.0.4_2019-05-05_Product_mhwx_xzz.apk';
                }
                if (GLOBAL.DEVICE_TYPE) {
            ...
            MobileEvent: function() {
                ...
                g.body.addEventListener('touchstart', aH, { passive: false });
                g.body.addEventListener('touchstart', aG, { passive: false });
            },
            PCEvent: function() {
                function aM(aN) {
                    if (aN.wheelDelta < 0 || aN.detail > 0) {
                        ...
                        an();
                        setTimeout(function() {
                            g.body.addEventListener('mousewheel', aM, { passive: false });
                            g.body.addEventListener('DOMMouseScroll', aM, { passive: false });
                        }, 2000);
                ...
                d.addEventListener('click', ae, { passive: false });
                e.addEventListener('click', an, { passive: false });
                for (var aD = 0, aF = ar.length; aD < aF; aD++) {
                    ar[aD].addEventListener('click', aK, { passive: false });
                }
                g.body.addEventListener('mousewheel', aM, { passive: false });
                g.body.addEventListener('DOMMouseScroll', aM, { passive: false });
                g.body.addEventListener('keyup', aL, { passive: false });
                ...
                aj.addEventListener('mouseenter', aG, { passive: false });
                aj.addEventListener('mouseleave', aH, { passive: false });
                ak.addEventListener('mouseenter', aG, { passive: false });
                ak.addEventListener('mouseleave', aH, { passive: false });
                al.addEventListener('mouseenter', aI, { passive: false });
                al.addEventListener('mouseleave', aJ, { passive: false });
                ...
                g.body.addEventListener('keyup', aE, { passive: false });
                c.addEventListener('click', aC, { passive: false });
        ...
        var ax = g.getElementById('page_download_pc_button'),
            ...
            // ah1 = g.getElementById('page_download_button1'),
            // ab1 = g.getElementById('page_download_button_top1'),
            ai = g.getElementById('page_download_mobile_iPhone'),
            ag = g.getElementById('page_download_mobile_android');
            // agp = g.getElementById('page_download_mobile_google');
        var j = g.getElementById('page_function1_book_page1'),
            ...
            l1 = g.getElementById('page_function1_book_page4'),
            l2 = g.getElementById('page_function1_book_page5'),
        ...
        var x = g.getElementById('page_function2_face_left'),
            ...
            q1 = g.getElementById('page_function2_book_1'),
        ...
        function at() {
            function aC() {
                ...
                // ah1.classList.add('animateMobileDownloadButtonIn');
            ...
            function aD() {
                ...
                aN.style.display = 'block';
                aA([j, k, l, l1, l2, n, m, p, o]);
                l2.classList.add('animateFunction1BookPage5In');
                l1.classList.add('animateFunction1BookPage4In');
            ...
            function aE() {
                ...
                aN.style.display = 'block';
                aA([x, z, y, A, q,q1, r, s, t, u, v, w, C, B]);
                ...
                setTimeout(function() {
                    q1.classList.add('animateFunction2BookIn');
                }, 300);
                setTimeout(function() {
        ...
        function av() {
            function aC() {
                ...
                // ah1.classList.add('animateMobileDownloadButtonOut');
                ax.classList.add('animateMobileDownloadButtonOut');
            }

            function aD() {
                aA([j, k, l,l1,l2, n, m, p, o]);
                l2.classList.add('animateFunction1BookPage5Out');
                l1.classList.add('animateFunction1BookPage4Out');
            ...
            function aE() {
                ...
                q1.classList.add('animateFunction2Book01Out');
        ...
        function aw() {
            ...
            function aI() {
                if (GLOBAL.DEVICE_TYPE === 1) {
                    ...
                    if (aj.style.display === 'none' || !aj.style.display) {
                        ...
                        /*aA(al);
                        al.style.display = 'block';
                        al.classList.add('animateBaseIn');*/
                    }
            ...
            function aJ() {
                if (GLOBAL.DEVICE_TYPE === 1) {
                    ...
                    /*aA(al);
                    al.classList.add('animateNavOut');
...
var shareTimeLineConfig = { img_url: "http://www.tap2world.com/images/share.jpg", link:"http://www.tap2world.com", desc: "港人睇世，萬眾觀港，坐擁最熱最新港聞時事，玩轉最High最In資訊", title: "香港頭條-香港人自己的頭條" };
var shareMessageConfig = { img_url: "http://www.tap2world.com/images/share.jpg", link:"http://www.tap2world.com", desc: "港人睇世，萬眾觀港，坐擁最熱最新港聞時事，玩轉最High最In資訊", title: "香港頭條-香港人自己的頭條" };
...
//       $.ajax({
//         type: "get",
//         url: "//wx-key.dftoutiao.com/wx/global/share_check.php",
//         data: {
//         url: url
//         },
//         dataType: "jsonp",
...
//             appId: json.appId,
//             timestamp: json.timestamp, //这个一定要与上面的php代码里的一样。
//             nonceStr: json.nonceStr, //这个一定要与上面的php代码里的一样。
...
//             title: '香港頭條-香港人自己的頭條', // 分享标题
//             desc: '港人睇世，萬眾觀港，坐擁最熱最新港聞時事，玩轉最High最In資訊', // 分享描述
//             link: 'http://www.tap2world.com', // 分享链接
//             imgUrl: 'http://www.tap2world.com/images/share.jpg', // 分享图标
//             success: function() {
